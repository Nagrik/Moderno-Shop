                        ...
                        <div className="cart">
                            ...
                            <div className="cart__bottom">
                                ...
                                <div className="cart__bottom-buttons">
                                    ...
                                    <Link to="/Products"
                                          className="button button--outline button--add go-back-btn button button--black">
                            ...
                            <div className="cart cart--empty">
                                ...
                                <p>
                                    Most likely you haven't ordered clothes yet.
                                    <br/>
                                    To order clothes, go to the main page.
                                </p>
